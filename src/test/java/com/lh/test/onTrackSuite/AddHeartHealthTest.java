...
/**
 * <h2>Configure OnTrack Add Heart Health instance!</h2> 
 * <p>
 * 
 * @author akash.vansil
 * @version 1.0
...
public class AddHeartHealthTest extends LHBaseTestClass{
	
	/** Logger for the AddHeartHealthTest class */
	private static Logger logger = LogManager.getLogger(AddHeartHealthTest.class);
	/**
	...
	public void initClass(){
		logger.info("Exiting the initClass() method for OnTrack AddHeartHealth Config Test instance class \n\n");
	...
	public void init(Method method) throws InterruptedException{
		logger.info("Inside the init() method for onTrack AddHeartHealth Config Test Page class...");
		//getDriverInstance();
		...
		logger.info("Exiting the init() method for onTrack AddHeartHealth Config Test class");
	}
	...
	{
		AddOnTrackConfigPageobj.SelectAirClient();
		SeleniumUtil.sleep(1);
		AddOnTrackConfigPageobj.SelectAirTrackCampaign();
		SeleniumUtil.sleep(1);
		AddOnTrackConfigPageobj.selectHeartHealthTrack();
	...
	public void tearDown() {
		...
		driver.quit();
		logger.info("Exiting the tearDown() method for nTrack AddHeartHealth Config Test \n\n");
	}
