...
/**
 * <h2>Configure OnTrack Steps instance!</h2> 
 * <p>
 * 
 * @author akash.vansil
 * @version 1.0
...
public class AddStepsTrackTest extends LHBaseTestClass{
	
	/** Logger for the AddStepsTrackTest class */
	private static Logger logger = LogManager.getLogger(AddStepsTrackTest.class);
	/**
	...
	public void initClass(){
		logger.info("Exiting the initClass() method for Add OnTrack Steps Config Test instance class \n\n");
	...
	public void init(Method method) throws InterruptedException{
		logger.info("Inside the init() method for Steps OnTrack Config Test Page class...");
		//getDriverInstance();
		...
		logger.info("Exiting the init() method for Add OnTrack Steps Config Test class");
	}
	...
	{
		AddOnTrackConfigPageobj.SelectAstraClient();
		SeleniumUtil.sleep(1);
		AddOnTrackConfigPageobj.SelectAstraTrackCampaign();
		AddOnTrackConfigPageobj.selectStepsTrack();
	...
	public void tearDown() {
		...
		driver.quit();
		logger.info("Exiting the tearDown() method for AddStepsTrack \n\n");
	}
