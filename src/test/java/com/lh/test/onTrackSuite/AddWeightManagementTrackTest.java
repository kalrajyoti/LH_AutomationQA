...
/**
 * <h2>Configure OnTrack Weight Management instance!</h2> 
 * <p>
 * 
 * @author akash.vansil
 * @version 1.0
...
public class AddWeightManagementTrackTest extends LHBaseTestClass{
	
	/** Logger for the Weight Management class */
	private static Logger logger = LogManager.getLogger(AddWeightManagementTrackTest.class);
	/**
	...
	public void initClass(){
		logger.info("Exiting the initClass() method for Add OnTrack Weight Management Config Test instance class \n\n");
	...
	public void init(Method method) throws InterruptedException{
		logger.info("Inside the init() method for Weight Management OnTrack Config Test Page class...");
		//getDriverInstance();
		...
		logger.info("Exiting the init() method for Add OnTrack Weight Management Config Test class");
	}
	...
	{
		AddOnTrackConfigPageobj.SelectWeightClient();
		SeleniumUtil.sleep(1);
		AddOnTrackConfigPageobj.SelectTrackWeightCampaign();
		AddOnTrackConfigPageobj.selectWeightManagementTrack();
