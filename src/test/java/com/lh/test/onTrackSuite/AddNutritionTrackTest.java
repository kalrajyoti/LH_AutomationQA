...
/**
 * <h2>Configure OnTrack Nutrition Track instance!</h2> 
 * <p>
 * 
 * @author akash.vansil
 * @version 1.0
...
public class AddNutritionTrackTest extends LHBaseTestClass{
	
	/** Logger for the AddNutritionTrackTest class */
	private static Logger logger = LogManager.getLogger(AddNutritionTrackTest.class);
	/**
	...
	public void initClass(){
		logger.info("Exiting the initClass() method for Add OnTrack NutritionTrack Config Test instance class \n\n");
	...
	public void init(Method method) throws InterruptedException{
		logger.info("Inside the init() method for NutritionTrack Config Test Page class...");
		//getDriverInstance();
		...
		logger.info("Exiting the init() method for Add OnTrack Config Test class");
	}
	...
	public void addOnTrackConfiguration()
	{
		...
		AddOnTrackConfigPageobj.SelectAppleClient();
		SeleniumUtil.sleep(1);
		AddOnTrackConfigPageobj.SelectTrackAppleCampaign();
		AddOnTrackConfigPageobj.selectNutritionTrack();
		SeleniumUtil.sleep(2);
