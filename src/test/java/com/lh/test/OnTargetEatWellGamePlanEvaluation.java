...
public class OnTargetEatWellGamePlanEvaluation extends AuthBaseTestClass{
	...
	public void startAndCompleteLevel1(){
		...
		onTargetPageObj.clickGetStartedOrNextLevelBtn();
		onTargetPageObj.selectAnswerForLevel1ActivityNutritionLabelHavingListOfRadioBtns1();
//		onTargetPageObj.selectAnswerForLevel1ActivityNutritionLabelHavingListOfRadioBtns(5);
//		onTargetPageObj.switchToQuizFrame();
//		onTargetPageObj.clickActivityCompleteBtn();
//		onTargetPageObj.switchToDefaultContent();
	...
	public void startAndCompleteLevel2(){
		...
		onTargetPageObj.fillingMealPlanningDetailsInLevel2();
		onTargetPageObj.clickLevelSubmitBtn();
	...
	public void classTearDown() {
		Reporter.log("Inside the classTearDown() method for OnTargetEatWellGamePlanEvaluation class...");
		onTargetPageObj = null;
		onTargetData = null;
		Reporter.log("Exiting the classTearDown() method for OnTargetEatWellGamePlanEvaluation class \n\n");
