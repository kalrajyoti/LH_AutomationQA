 ...
 * @since 2015-02-08
 */
public class LHBaseTestClass {

	private static Logger logger 		= LogManager.getLogger(LHBaseTestClass.class);

	protected static final String LH_WORKBOOK 	= TestProperty.TESTDATA_WORKBOOK;
	protected static final String baseUrl 		= TestProperty.BASEURL;
